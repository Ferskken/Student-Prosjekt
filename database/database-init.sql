CREATE TABLE books (
    ...
    VALUES 
      /*  ('The Lord of the Rings','J.R.R. Tolkien','Houghton Mifflin','29-07-1954','9780261103689','2021','English'),
        ('Ringenes Herre','J.R.R. Tolkien','Houghton Mifflin','29-07-1954','9780261103689','2021','Norsk'),
        ('The Lord of the Rings: The Two Towers','J.R.R. Tolkien','Houghton Mifflin','11-11-1954','9780261103610','2021','English'),
        ('Ringenes Herre: To tårn','J.R.R. Tolkien','Houghton Mifflin','11-11-1954','9780261103610','2022','Norsk'),
        ('The Lord of the Rings: Return of the King','J.R.R. Tolkien','Houghton Mifflin','20-10-1955','9780261103666','2022','English'),
        ('Ringenes Herre: Atter en konge','J.R.R. Tolkien','Houghton Mifflin','20-10-1955','9780261103666','2021','Norsk'),
        ('The Bible','King James','HHarper & Row','16-05-1611','9780261103666','1995','English'),
        ('1984', 'George Orwell', 'Secker & Warburg', '08-06-1949', '9780451524935', '2009', 'English'),
        ('Nineteen Eighty-Four', 'George Orwell', 'Gyldendal', '08-06-1949', '9780451524935', '2010', 'Norsk'),
        ('Brave New World', 'Aldous Huxley', 'Chatto & Windus', '01-09-1932', '9780060850524', '2006', 'English'),
        ('Verden i 2020', 'Aldous Huxley', 'Gyldendal Norsk Forlag', '01-09-1932', '9780060850524', '2010', 'Norsk'),
        ('Pride and Prejudice', 'Jane Austen', 'T. Egerton', '28-01-1813', '9780141040349', '2009', 'English'),
        ('Stolthet og fordom', 'Jane Austen', 'Gyldendal', '28-01-1813', '9780141040349', '2010', 'Norsk'),
        ('Moby Dick', 'Herman Melville', 'Harper & Brothers', '18-10-1851', '9780142437247', '2002', 'English'),
        ('Moby Dick: Hvalen', 'Herman Melville', 'Aschehoug', '18-10-1851', '9780142437247', '2003', 'Norsk'),
        ('War and Peace', 'Leo Tolstoy', 'The Russian Messenger', '09-01-1869', '9780199232765', '2007', 'English'),
        ('Krig og fred', 'Leo Tolstoy', 'Gyldendal Norsk Forlag', '09-01-1869', '9780199232765', '2011', 'Norsk'),
        ('Crime and Punishment', 'Fyodor Dostoevsky', 'The Russian Messenger', '01-01-1866', '9780143058144', '2002', 'English'),
        ('Forbrytelse og straff', 'Fyodor Dostoevsky', 'Gyldendal', '01-01-1866', '9780143058144', '2003', 'Norsk'),
        ('The Great Gatsby', 'F. Scott Fitzgerald', 'Charles Scribner Sons', '10-04-1925', '9780743273565', '2004', 'English'),
        ('Den store Gatsby', 'F. Scott Fitzgerald', 'Gyldendal', '10-04-1925', '9780743273565', '2005', 'Norsk'),
        ('To Kill a Mockingbird', 'Harper Lee', 'J.B. Lippincott & Co.', '11-07-1960', '9780060935467', '2006', 'English');
